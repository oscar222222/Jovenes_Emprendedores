...
public partial class View_view_young_innova_Registration_of_idea : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
                ...
                n.RegisterClientScriptBlock(this.GetType(), "", "<script type='text/javascript'>alert('Espere un momento'); window.location = '/View/view_young_innova/InnovatorPage1.aspx';</script>");
